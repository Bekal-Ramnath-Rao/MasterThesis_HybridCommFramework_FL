...
Duplicated here (same as ``scripts/utilities/battery_results_agg.py``) so Docker/server
images that only ship ``Server/`` work without ``scripts/utilities/``. Keep both copies aligned.
"""
