...
HTTP3_HOST = os.getenv("HTTP3_HOST", "fl-server-http3-Temperature_Regulation")
...
async def main():
    print(f"\n{'='*70}")
    print(f"Federated Learning Server with HTTP/3 - Temperature Regulation Recognition")
