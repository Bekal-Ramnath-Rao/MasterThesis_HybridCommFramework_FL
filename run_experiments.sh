...
#     --protocols mqtt amqp grpc --scenarios excellent good moderate poor very_poor congested_light congested_moderate congested_heavy \
...
python3 Network_Simulation/run_network_experiments.py \
    ...
    --quantization-strategy parameter_quantization \
    --quantization-bits 16 --rounds 1000 \
    --protocols quic dds --scenarios excellent good moderate congested_light congested_moderate congested_heavy poor very_poor \
    2>&1 | tee "$LOG_DIR/exp4_quantized_${TIMESTAMP}.log"
